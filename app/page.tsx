...
export default function HomePage() {
  ...
  const { user, isLoading, isVerifying, verificationError, login, logout } =
    useUser();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          style={{ color: "#c8b8a2", fontSize: "11px", letterSpacing: "0.1em" }}
        >
          鍛錬 · 競争 · 成長
        </span>
      </div>
            ...
            {step === "input" && (
              ...
              >
                <input
                  ...
                  onKeyDown={(e) =>
                    e.key === "Enter" && handle.trim() && handleLogin()
                  }
                  style={{
                    width: "100%",
                    background: "#faf7f4",
          ...
          >
            {[
              [
                "確認",
                "Verify",
                "Prove your Codeforces handle via a compilation error.",
              ],
              [
                "修行",
                "Train",
                "Generate problems by rating range and tags. Persists across sessions.",
              ],
              ...
              [
                "成長",
                "Improve",
                "Watch your platform rating climb in Statistics.",
              ],
            ].map(([jp, en, desc], i) => (
              <div
                key={i}
              ...
              >
                <div style={{ minWidth: "32px" }}>
                  <p style={{ color: "#c0392b", fontSize: "12px", margin: 0 }}>
                    {jp}
                  </p>
                  <p
                    style={{
